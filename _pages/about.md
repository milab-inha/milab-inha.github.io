...
<div style="overflow: auto;">    
    <figure style="float: right; margin-left: 20px; margin-bottom: 10px;">
        ...
        <figcaption>
            Image generated by Dall&middot;E 2 using a description of "research on intersection of computer vision, image processing, and inverse problems, with a particular focus on deep generative models by Pablo Picasso."
        </figcaption>
    </figure>
    <div class="lab-text">
